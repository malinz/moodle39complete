...
class block_unitec_teacher_block extends block_base {
    ...
    protected function render_user_profile($userid) {
        ...
        if ($user) {
            ...
            $html .= html_writer::tag('div', $this->user_department($user), array('class' => 'detail department'));
    ...
    protected function user_role(&$user) {
      ...
      /**
     * Get an array of user department field to be displayed.
     *
     * @param object $user
     * @param int $key
     * @return array
    ...
    protected function user_department(&$user) {
        
        if ($this->config->display_department && $user->department != '') {
