...
if ($ADMIN->fulltree) {
    ...
    // Display department.
    $name = 'block_unitec_teacher_block/display_department';
    $title = get_string('display_department', 'block_unitec_teacher_block');
    $description = get_string('display_department_desc', 'block_unitec_teacher_block');
    $default = 0;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default);
    $settings->add($setting);
