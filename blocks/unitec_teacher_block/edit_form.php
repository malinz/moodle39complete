...
class block_unitec_teacher_block_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        // Department.
        $mform->addElement('advcheckbox', 'config_display_department',
            get_string('display_department_desc', 'block_unitec_teacher_block'));
        $mform->setDefault('config_display_department', $config->display_profile_picture);
